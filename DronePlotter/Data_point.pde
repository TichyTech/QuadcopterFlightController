...
class SensorDataPoints{
  ...
  void save_to_file(){
    ...
    for (int i = 0; i < this.items; i++){
      ...
      String ms_string = String.format("%d ", c_ms);
      String RPY_string = String.format("%.2f %.2f %.2f ", c_RPY[0], c_RPY[1], c_RPY[2]);
      String acc_string = String.format("%.2f %.2f %.2f ", c_acc[0], c_acc[1], c_acc[2]);
      String mag_string = String.format("%.2f %.2f %.2f ", c_mag[0], c_mag[1], c_mag[2]);
      String gyro_string = String.format("%.2f %.2f %.2f ", c_gyro[0], c_gyro[1], c_gyro[2]);
